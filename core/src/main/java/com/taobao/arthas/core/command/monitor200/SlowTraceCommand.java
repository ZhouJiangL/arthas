...
public class SlowTraceCommand extends EnhancerCommand {
    ...
    @Option(shortName = "c", longName = "threshold")
    ...
    protected AdviceListener getAdviceListener(CommandProcess process) {
        if (pathPatterns == null || pathPatterns.isEmpty()) {
            return new SlowTraceAdviceListener(this, process);
        } else {
            return new PathSlowTraceAdviceListener(this, process);
        }
    }
